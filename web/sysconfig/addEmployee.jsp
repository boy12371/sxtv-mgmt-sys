...
<h1>员工信息</h1>
<img class="pageImage"
	src="${pageContext.request.contextPath}/common/images/employee.png"
	border="0">
<p>编辑并更新员工信息</p>
...
<s:form action="/sys/doAddEmployee" method="post">
	...
	<table class="inputTable">
		<tr>
			...
			<s:hidden name="employee.status" value="1" /></td>
		</tr>
		<tr>
			<td><label>性别：</label></td>
			<td><s:select cssClass="selectField" name="employee.gender"
				list="#{'1':'男','0':'女'}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><s:textarea cssClass="inputField" name="employee.comments"
				cols="20" rows="2"></s:textarea></td>
		</tr>
