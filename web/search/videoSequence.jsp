...
<table>	
	...
	<tr>
		<td><label>从</label></td>
		<td><sx:datetimepicker name="startDate" toggleType="explode" displayFormat="yyyy-MM-dd" id="startDate" value="%{'today'}"/></td>
		<td><label>至</label></td>
		<td><sx:datetimepicker name="endDate" toggleType="explode" displayFormat="yyyy-MM-dd" id="endDate" value="%{'today'}" /></td>
