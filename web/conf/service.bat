...
set SERVICE_NAME=vmsWebService
set PR_DISPLAYNAME=SXTVS Video Management System
...
set PR_DESCRIPTION=SXTVS video management system
...
at 13:00 /every:M,T,W,Th,F "%CATALINA_HOME%\..\bin\dbbakup.bat"
:end
cd %CURRENT_DIR%
